export const MSG = {
  SUCCESS: {
    ...
    LARGE_UPLOAD_INITIATED: 'LARGE_UPLOAD_INITIATED',
    LARGE_UPLOAD_CHUNK_RECEIVED: 'LARGE_UPLOAD_CHUNK_RECEIVED',
    LARGE_UPLOAD_ABORTED: 'LARGE_UPLOAD_ABORTED',
    ...
    RECURRING_RULE_CREATED: 'RECURRING_RULE_CREATED',
    RECURRING_RULE_UPDATED: 'RECURRING_RULE_UPDATED',
    RECURRING_RULE_DELETED: 'RECURRING_RULE_DELETED',
  ...
  ERROR: {
    ...
    OAUTH_VERIFY_EMAIL_FIRST: 'OAUTH_VERIFY_EMAIL_FIRST',
    ...
    CUSTOM_FIELD_NEEDS_OPTIONS: 'CUSTOM_FIELD_NEEDS_OPTIONS',
    RECURRING_RULE_NOT_FOUND: 'RECURRING_RULE_NOT_FOUND',
    ...
    PARENT_NOT_IN_PROJECT: 'PARENT_NOT_IN_PROJECT',
    EPIC_NOT_IN_PROJECT: 'EPIC_NOT_IN_PROJECT',
    SPRINT_NOT_IN_PROJECT: 'SPRINT_NOT_IN_PROJECT',
    COLUMN_NOT_IN_BOARD: 'COLUMN_NOT_IN_BOARD',
    PARENT_NOT_IN_ISSUE: 'PARENT_NOT_IN_ISSUE',
    LABEL_NOT_IN_PROJECT: 'LABEL_NOT_IN_PROJECT',
    LABEL_NOT_FOUND: 'LABEL_NOT_FOUND',
    LABEL_ALREADY_EXISTS: 'LABEL_ALREADY_EXISTS',
    COMMENT_NOT_FOUND: 'COMMENT_NOT_FOUND',
    ATTACHMENT_NOT_FOUND: 'ATTACHMENT_NOT_FOUND',
    LARGE_UPLOAD_SESSION_NOT_FOUND: 'LARGE_UPLOAD_SESSION_NOT_FOUND',
    LARGE_UPLOAD_CHUNK_INDEX_OUT_OF_RANGE:
      'LARGE_UPLOAD_CHUNK_INDEX_OUT_OF_RANGE',
    LARGE_UPLOAD_INCOMPLETE: 'LARGE_UPLOAD_INCOMPLETE',
    LARGE_UPLOAD_TOO_LARGE: 'LARGE_UPLOAD_TOO_LARGE',
    LARGE_UPLOAD_SIZE_MISMATCH: 'LARGE_UPLOAD_SIZE_MISMATCH',
    LARGE_UPLOAD_CHUNKS_MISSING: 'LARGE_UPLOAD_CHUNKS_MISSING',
    LARGE_UPLOAD_IN_PROGRESS: 'LARGE_UPLOAD_IN_PROGRESS',
    LARGE_UPLOAD_ALREADY_COMPLETED: 'LARGE_UPLOAD_ALREADY_COMPLETED',
